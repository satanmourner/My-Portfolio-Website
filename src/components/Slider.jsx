...
export default class Slider extends React.Component {
  ...
  print(event) {
    ...
    console.log(event.target, this.refSlide[0]);
      ...
      <div className="slider">
        <img className="slide-img" src={process.env.PUBLIC_URL + '/Images/wall.png'}  /> 
          ...
          <div className="dot-slide">
                  <i className="fa fa-circle" onClick={this.print} ref={ref => this.refSlide.push(ref)} />
                  <i className="fa fa-heart" onClick={this.print} ref={ref => this.refSlide.push(ref)} />
          </div>
        </div>
      </div>
    );
